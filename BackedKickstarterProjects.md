...
|[IoTFi 4G Hardware](https://github.com/sbcshop/IoTFi-4G-Hardware) |IoT-Fi is a compact low power IoT enabled device having the capability of GSM modules (SIM868/SIM7600G-H) for providing network connectivity via using sim card and having the power of RP2040 chip. …|
| [IoTFi 4G Software](https://github.com/sbcshop/IoTFi_4G_Software) |IoT-Fi is a compact low power IoT enabled device having the capability of GSM module (SIM868) for providing network connectivity via using sim card and having the power of RP2040 chip. It also cons…|
